...
namespace ReadingRoom.Api.Controllers
{
    ...
    public class ReservationController : ControllerBase
    {
        ...
        /// <summary>
        /// Retrieve rooms by room id for give time range
        /// </summary>
        [HttpGet]
        public IActionResult GetByRoomIdAndDate([FromQuery] int roomId, [FromQuery] DateTime from, [FromQuery] DateTime to)
        {
            var reservations = _service.GetByRoomIdAndDate(roomId, from, to);
            return Ok(reservations);
        }

        /// <summary>
        /// Retrieve reservations with conflicts
        /// </summary>
        [HttpGet("conflicts")]
        public IActionResult GetConflicts()
        {
            return Ok(_service.GetConflicts());
        }
